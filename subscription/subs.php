...
$allowed_plans = ['Diet', 'Protein', 'Royal'];
$name_plan = (isset($_GET['plan']) && in_array($_GET['plan'], $allowed_plans)) ? $_GET['plan'] : 'Diet';
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-12 ms-auto mb-5 mb-lg-0">
                <div>
                    <h4>Subscribe to <?php echo "$name_plan";?> Plan</h4>
                    <div class="d-flex align-items-baseline gap-2">
                        <h2 class=mb-0 me-1>Rp<?php echo number_format($price, 0, ',', '.'); ?></h2>
