                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mx-auto">
                        ...
                        <p class="text-white d-flex mb-2">
                            ...
                            <a href="tel: 08123456789" class="site-footer-link">
                                0812-3456-789 (Brian)
                            </a>
                        </p>
                        ...
                        <p class="text-white d-flex">
                            ...
                            <a href="brian@seacatering.com" class="site-footer-link">
                        ...
                        <p class="text-white d-flex mt-3">
                            ...
                            COMPFEST 17, Fasilkom Universitas Indonesia
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-7 col-12">
                            <p class="copyright-text mb-0">Copyright © 2025 <a href="https://compfest.id/" target="_blank">COMPFEST 17</a></p>
                        </div>
